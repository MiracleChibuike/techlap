              ...
              <div className="productBox shadow-lg">
                <div className="product_body_container">
                  ...
                  <p className="message text-secondary">
                    Please use this form to upload all products with their
                    features
                  </p>
                  <div className="form-add-product">
                    <form action="">
                      ...
                      {/* P-series */}
                      <div className="p-series mt-3">
                        <label htmlFor="pSeries">Product Series</label>
                        <input
                          type="text"
                          className="p-2"
                      ...
                      <div className="p-size mt-3">
                        <label htmlFor="pSize">
                          Product Screen Size <small>*(inches)</small>
                        </label>
                        <input
                          type="number"
                          className="p-2"
                          placeholder="product size Eg. 15.7"
                          id="pSize"
                          name="product_size"
                        />
                      </div>
                      ...
                      {/* Manufacturer */}
                      <div className="p-manufacturer mt-3">
                        <label htmlFor="pManufacturer">Manufactured By</label>
                        <input
                          type="text"
                          className="p-2"
                          placeholder="Enter manufacture's name Eg. Microsoft"
                          id="pManufacturer"
                          name="product_manufacturer"
                        />
                      </div>
                      {/* Guarantee */}
                      <div className="p-guarantee mt-3">
                        <label htmlFor="pGuarantee">Product Warranty</label>
                        <input
                          type="number"
                          className="p-2"
                          placeholder="Enter duration of warranty"
                          id="pGuarantee"
            ...
            <div className="mainPanel p-lg-3">
              ...
              <div className="admin_Analytics p-lg-4 mt-lg-2">
                <div className="classify">
                  ...
                  <p>
                    <small>
                      Explore products and see how they have performed
                    </small>
                  </p>
                </div>
                <div className="Ikumi_analytics_insight_top">
                  ...
                  <div className="new_consultations p-3" id="loadOrders">
                    <p>
                      <small>
                        Low <strong id="in_stock">Stock</strong>
                      </small>
                    </p>
                    <div className="d-flex justify-content-between">
                      <p>
                  ...
                  {/* Add Products button */}
                  <div
                    className="new_consultations p-3"
                    id="add-protocol"
                    ref={showProductsIcon}>
              ...
              <div className="panelContainer p-2">
                <div className="text-center parent_text">
                  <Link to={"/auth/admin"}>
                    ...
                    <p className="mt-1 child_text inactive">

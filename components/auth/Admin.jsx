            ...
            <div className="outSign">
              <div className="signOut p-3 shadow-lg m-4 rounded-2">
                <div className="text-center">
                  ...
                  <p className="mt-2">
                    Sign in whenever you wish to continue from where you
                    stopped.
                  </p>
                </div>
              </div>
              ...
              <div className="invalid-modal shadow-lg border-1 rounded-2 p-3 bg-white">
                <div className="">
                  ...
                  <div className="mt-2 text-center">
                    ...
                    You don’t have the right permissions to view this page. If
                    you need access, please contact your administrator.
                  </div>
                </div>
              </div>
            </div>
